        ...
        <form action="{{ route('preventives.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="id_preventive" required
                    class="w-full bg-darkbg border border-darkborder rounded-lg px-4 py-2 text-white focus:outline-none focus:border-limeacc font-mono"
            ...
            <div class="flex justify-end space-x-3 pt-4">
                <a href="{{ route('preventives.index') }}" class="px-4 py-2 bg-darkborder text-gray-300 rounded-lg hover:bg-darkbg transition">
                    Annuler
                </a>
